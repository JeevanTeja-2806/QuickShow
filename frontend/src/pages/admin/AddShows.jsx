    ...
    <>
      ...
      <div className='mt-8'>
        ...
        <div className='inline-flex items-center gap-2 border border-gray-600 px-3 py-2 rounded-md'>
          ...
          <input type="number" value={showPrice} onChange={(e) => setShowPrice(e.target.value)} placeholder='Enter Show Price' className='outline-none' />
        </div>
      </div>
      ...
      <div className='mt-6 '>
        ...
        <div className='flex items-center gap-4'>
          <input type="datetime-local" value={dateTimeInput} onChange={(e) => setDateTimeInput(e.target.value)} className='w-64 border border-gray-400 px-3 py-2 outline-none rounded-md' />
          <button onClick={handleDateTimeAdd} className='bg-red-400/80 text-white px-3 py-2 text-sm rounded-lg hover:bg-red-400 cursor-pointer'>
            Add Time
          </button>
        </div>
      </div>  
        ...
        <button className='bg-red-400 text-white px-8 py-2 mt-6 rounded hover:bg-red-400/90 transition-all cursor-pointer'>
          Add Show
        </button>
      </>
  ) : <Loading />
